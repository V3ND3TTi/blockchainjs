...
describe('Transaction', () => {
  ...
  describe('outputMap', () => {
    ...
    it('outputs the remaining balance for the `senderWallet`', () => {
      expect(transaction.outputMap[senderWallet.address])
    ...
    describe('when the transaction is invalid', () => {
      describe('and a transaction outputMap value is invalid', () => {
        it('returns false and logs an error', () => {
          transaction.outputMap[senderWallet.address] = 999999;
  ...
  describe('update()', () => {
    ...
    describe('and the amount is valid', () => {
      beforeEach(() => {
        ...
        originalSenderOutput = transaction.outputMap[senderWallet.address];
  ...
  describe('rewardTransaction()', () => {
    ...
    it('creates one transaction for the miner with the `MINING_REWARD`', () => {
      expect(rewardTransaction.outputMap[minerWallet.address]).toEqual(MINING_REWARD);
    });
  });
});